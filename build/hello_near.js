...
class Appointment {
  constructor(patientId, date, doctor, fee) {
...
let PatientContract = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = call({}), _dec4 = view(), _dec5 = view(), _dec6 = call({}), _dec7 = call({}), _dec(_class = (_class2 = class PatientContract {
  constructor() {
  ...
  savePatients() {
    storageWrite("patients", JSON.stringify(Array.from(this.patients.entries())));
  }
  loadPatients() {
    const patientsRaw = storageRead("patients");
    if (patientsRaw) {
      this.patients = new Map(JSON.parse(patientsRaw));
    }
  }
  saveAppointments() {
    storageWrite("appointments", JSON.stringify(this.appointments));
  }
  loadAppointments() {
    const appointmentsRaw = storageRead("appointments");
    if (appointmentsRaw) {
  ...
  registerPatient({
    ...
    this.loadPatients();
    const patientId = signerAccountId();
  ...
  deposit() {
    this.loadPatients();
    const amount = BigInt(attachedDeposit().toString());
    const patientId = signerAccountId();
    if (this.patients.has(patientId)) {
      let patient = this.patients.get(patientId);
  ...
  withdraw({
    ...
    if (this.patients.has(patientId)) {
      ...
      const promise = promiseBatchCreate(patientId);
      promiseBatchActionTransfer(promise, amountBigInt);
      this.savePatients();
    }
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "registerPatient", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "registerPatient"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "scheduleAppointment", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "scheduleAppointment"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getPatient", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "getPatient"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getAppointments", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "getAppointments"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "deposit", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "deposit"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "withdraw", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "withdraw"), _class2.prototype)), _class2)) || _class);
function withdraw() {
  const _state = PatientContract._getState();
  if (!_state && PatientContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = PatientContract._create();
  if (_state) {
    PatientContract._reconstruct(_contract, _state);
  }
  const _args = PatientContract._getArgs();
  const _result = _contract.withdraw(_args);
  PatientContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PatientContract._serialize(_result, true));
}
function deposit() {
  const _state = PatientContract._getState();
  if (!_state && PatientContract._requireInit()) {
...
function getAppointments() {
  ...
  const _args = PatientContract._getArgs();
  const _result = _contract.getAppointments(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PatientContract._serialize(_result, true));
}
function getPatient() {
  const _state = PatientContract._getState();
  ...
  const _args = PatientContract._getArgs();
  const _result = _contract.getPatient(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PatientContract._serialize(_result, true));
}
function scheduleAppointment() {
  ...
  const _args = PatientContract._getArgs();
  const _result = _contract.scheduleAppointment(_args);
  PatientContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PatientContract._serialize(_result, true));
}
function registerPatient() {
  ...
  const _args = PatientContract._getArgs();
  const _result = _contract.registerPatient(_args);
  PatientContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(PatientContract._serialize(_result, true));
}

export { deposit, getAppointments, getPatient, registerPatient, scheduleAppointment, withdraw };
